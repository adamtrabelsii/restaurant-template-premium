          ...
          <div className="flex gap-6 items-start">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-cormorant font-semibold text-ardor-dark text-lg">{t('about.chefName')}</p>
                  <p className="font-montserrat text-xs text-gray-400 tracking-widest uppercase">{t('about.chefRole')}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <motion.div variants={revealRight} initial={initial} whileInView={whileInView} viewport={vp}>
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
              <p className="font-montserrat text-xs tracking-[0.3em] uppercase text-white/70">{t('about.imageCaption')}</p>
            </div>
          </div>
        </motion.div>
